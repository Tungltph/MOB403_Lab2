    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //goi AsyncTask
                new Demo22Asyn().execute("https://assetsio.reedpopcdn.com/Genshin-Impact-beginner%E2%80%99s-guide-for-2023%2C-tips-and-tricks-cover.jpg?width=1920&height=1920&fit=bounds&quality=80&format=jpg&auto=webp");
            }
        });
    }
